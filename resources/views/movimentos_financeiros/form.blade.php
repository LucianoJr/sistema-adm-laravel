<div class="form-group row {{ $errors->has('descricao') ? 'has-error' : ''}}">
    ...
    <div class="col-sm-10">
        <select class="form-control" name="empresa_id" id="empresa-ajax" required style="width:100%"></select>
        {!! $errors->first('empresa_id', '<p class="help-block">:message</p>') !!}
    </div>
</div>

<div class="form-group">
    <input class="btn btn-primary" type="submit" value="{{ $formMode === 'edit' ? 'Salvar' : 'Salvar' }}">
</div>
