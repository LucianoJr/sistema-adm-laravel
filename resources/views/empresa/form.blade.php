...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input type="text" id="celular" name="celular" required="required" maxlength="15" class="celular form-control">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input type="email" id="email" name="email" required="required" maxlength="100" class="form-control">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input type="text" id="cep" name="cep" required="required" maxlength="9" class="cep form-control">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input type="text" id="bairro" name="bairro" required="required" maxlength="100" class="form-control">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input type="text" id="estado" name="estado" required="required" maxlength="100" class="form-control"> 
    </div>
</div>
<div class="form-group row">
